...
jQuery(document).ready(function () {
  $('[data-bs-toggle="popover"]').popover(), Travl.init();
}),
...
var imageId = document.getElementById("img_sm");
var imageId2 = document.getElementById("img_lg");
document.getElementById("ToggleLogo").addEventListener("click", () => {
  if (imageId.classList.contains("d-none")) {
    imageId.classList.replace("d-none", "d-block");
    imageId2.classList.replace("d-block", "d-none");
  } else {
    imageId.classList.replace("d-block", "d-none");
    imageId2.classList.replace("d-none", "d-block");
  }
});
