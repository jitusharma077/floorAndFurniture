...
function dlabSettings({
  ...
  (this.typography = a || "poppins"),
    (this.version = t || "light"),
    (this.layout = r || "vertical"),
    (this.navheaderBg = e || "color_1"),
    (this.headerBg = o || "color_1"),
    (this.sidebarStyle = d || "full"),
    (this.sidebarBg = b || "color_1"),
    (this.sidebarPosition = i || "static"),
    (this.headerPosition = c || "static"),
    (this.containerLayout = s || "wide"),
    (this.direction = l || "ltr"),
    (this.primary = y || "color_1"),
...
(dlabSettings.prototype.manageVersion = function () {
  ...
  (dlabSettings.prototype.manageSidebarPosition = function () {
    switch (this.sidebarPosition) {
      case "fixed":
        ("overlay" === this.sidebarStyle && "vertical" === this.layout) ||
        "modern" === this.sidebarStyle
  ...
  (dlabSettings.prototype.manageResponsiveSidebar = function () {
    ...
    a < 1024 &&
      (body.attr("data-layout", "vertical"),
      body.attr("data-container", "wide")),
      a > 767 && a < 1024 && body.attr("data-sidebar-style", "mini"),
      a < 768 && body.attr("data-sidebar-style", "overlay");
  }),
